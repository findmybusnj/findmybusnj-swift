...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func applicationWillResignActive(_ application: UIApplication) {
    ...
    // Update favorties
    shortcutItemManager.updateShortcutItemsWithFavorites(favorites)
  ...
  func application(_ application: UIApplication,
    ...
    if rootView.childViewControllers[0].childViewControllers[0].isKind(of: ETABusTimeTableController.self) {
   ...
   */
  fileprivate func handleShortcut(_ shortcut: UIApplicationShortcutItem) -> Bool {
    ...
    switch shortcutIdentifier {
      case ShortcutIdentifier.openSearch:
        let searchPopover = storyboard.instantiateViewController(withIdentifier: "ETASearchPopOverController")
        root?.present(searchPopover, animated: true, completion: nil)
  ...
  lazy var applicationDocumentsDirectory: URL = {
    /** The directory the application uses to store the Core Data store file.
      This code uses a directory named "aghassi.findmybusnj" in the application's
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "FindMyBusCoreDataModel", withExtension: "momd")!
